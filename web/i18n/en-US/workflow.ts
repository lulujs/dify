const translation = {
  common: {
    ...
    typeNotCompatible: 'Type not compatible',
  ...
  nodes: {
    ...
    llm: {
      ...
      promptTemplate: {
        ...
        description: 'Choose from pre-built prompt templates to quickly set up your LLM node.',
        confirmTitle: 'Apply Template?',
        confirmMessage: 'Applying this template will replace your current prompt configuration.',
        ...
        previewPlaceholder: 'Select a template to preview',
        editPlaceholder: 'Select a template to edit',
        pagination: 'Page {{current}} / {{total}} items, {{pageSize}} per page',

const translation = {
  ...
  nodes: {
    ...
    llm: {
      ...
      promptTemplate: {
        title: '提示词模板',
        description: '从预设的提示词模板中选择，快速配置您的 LLM 节点。',
        confirmTitle: '应用模板？',
        confirmMessage: '应用此模板将替换您当前的提示词配置。',
        promptName: 'Prompt名称',
        model: '使用模型',
        template: 'Prompt模板',
        actions: '操作',
        ...
        editArea: '编辑区域',
        currentModel: '当前选中',
        previewPlaceholder: '请选择一个模板进行预览',
        editPlaceholder: '请选择一个模板进行编辑',
        pagination: '第{{current}}页 / 共{{total}}条记录，每页显示{{pageSize}}条',
        previousPage: '上一页',
        nextPage: '下一页',
        workspace: '资源空间',
        mine: '我创建的',
        searchPlaceholder: '根据名称或内容搜索...',
        noResults: '未找到匹配的模板',
        noMyTemplates: '您还没有创建任何模板',
      },
      jsonSchema: {
        title: '结构化输出 Schema',
        instruction: '指令',

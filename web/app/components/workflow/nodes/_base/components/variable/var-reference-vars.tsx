...
const varChildrenToProperties = (children: Var[]): Record<string, Field> => {
  ...
  children.forEach((child) => {
    ...
    // Recursively convert nested Var[] children (only for object and file types)
    if (
      ...
      <PortalToFollowElemContent style={{
        ...
        {(isStructureOutput || isObj) && (
          <PickerStructurePanel
            root={{ nodeId, nodeName: title, attrName: itemData.variable, attrAlias: itemData.schemaType || itemData.type }}
